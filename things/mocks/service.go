...
import (
	...
	magistrala "github.com/andychao217/magistrala"
...
func (_m *Service) ListClients(ctx context.Context, token string, reqUserID string, pm clients.Page, showFullData string) (clients.ClientsPage, error) {
